...
const lensLightingNotes = [
  { scene: "34", lens: "24mm + Drone wide", lighting: "Natural daylight, bounce fill on faces", date: "Oct 10" },
  { scene: "55", lens: "50mm Anamorphic", lighting: "Magic hour only — pre-light 5:30PM, 30 min window", date: "Oct 12" },
  { scene: "41", lens: "85mm prime, shallow stop", lighting: "Single hard source key, NTR held in shadow till reveal", date: "Oct 14" },
];
    ...
    >
      ...
      <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <h2 className="text-lg sm:text-xl font-display font-bold">Lens &amp; Lighting Plans</h2>
            <div className="space-y-3">
              {lensLightingNotes.map((n, i) => (
                <Card key={i} className="bg-card border-border border-l-2 border-l-primary">
                  <CardContent className="p-4">
                    ...
                    <p className="text-xs font-medium mb-1">{n.lens}</p>
                    <p className="text-xs text-muted-foreground leading-relaxed">{n.lighting}</p>
                  </CardContent>
                </Card>
              ))}
            </div>

        ...
        <div className="flex-1 bg-background overflow-y-auto pb-20">
          ...
          <div className="px-4 py-2 space-y-3">
            ...
            <div className="bg-card border-l-4 border-primary rounded-r p-3 shadow-sm">
              <div className="flex justify-between items-start mb-1">
                <span className="font-display font-bold text-lg">Sc 12</span>
                <span className="text-[10px] bg-primary/20 text-primary px-2 py-0.5 rounded font-bold uppercase">Now Shooting</span>
              </div>
              <p className="text-sm font-medium mb-3">Palace Interior</p>
              <div className="space-y-1 text-xs">
                <div className="flex justify-between text-muted-foreground">
                  <span>NTR</span> <span className="text-green-400 font-bold">✓ On Set</span>
                </div>
                <div className="flex justify-between text-muted-foreground">
                  <span>Saif</span> <span className="text-yellow-400 font-bold">↻ In Makeup (10m)</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-card border-l-4 border-border rounded-r p-3 opacity-60">
              <div className="flex justify-between items-start mb-1">
                <span className="font-display font-bold text-lg">Sc 23</span>
                <span className="text-[10px] bg-muted px-2 py-0.5 rounded font-bold uppercase text-muted-foreground">Up Next</span>
              </div>
              <p className="text-sm font-medium">Flashback Village</p>
            </div>
          </div>

          <div className="px-4 mt-6">
            <div className="grid grid-cols-2 gap-2">
              <button className="bg-card border border-border p-3 rounded-lg flex flex-col items-center justify-center gap-2 hover:bg-muted active:bg-muted/50 transition-colors">
          ...
          <div className="px-4 mt-6">
            ...
            <div className="space-y-2">
              <div className="bg-red-500/10 border border-red-500/20 p-2 rounded text-xs flex gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-red-500 mt-1 shrink-0" />
                <span className="text-red-400 font-medium">Generator 2 making noise, sound dept complaining.</span>
              </div>
            </div>
          </div>
        </div>

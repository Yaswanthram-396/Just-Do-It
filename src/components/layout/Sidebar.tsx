  ...
  return (
    <Sidebar className="border-r border-border bg-sidebar">
      <SidebarHeader className="p-4 border-b border-border bg-sidebar">
        {!isCollapsed ? (
          <div className="flex flex-col gap-1">
            ...
            {role && (
              <div className="mt-2 inline-flex w-fit items-center rounded-md border border-primary/20 bg-primary/10 px-2 py-0.5 text-[10px] font-semibold text-primary transition-colors focus:outline-none">
                Viewing as: {role}
              </div>
            )}
          </div>
      ...
      <SidebarContent className="bg-sidebar">
        <SidebarGroup>
          <SidebarGroupLabel className="text-muted-foreground font-semibold px-3 uppercase tracking-wider text-[10px]">Production</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
                  ...
                  <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton 
                      ...
                      className={cn(
                        ...
                        isActive 
                          ? "bg-primary/20! text-primary! border-l-4 border-primary! rounded-r-md rounded-l-none font-bold" 
                          : "text-muted-foreground hover:bg-primary/10 hover:text-primary rounded-md"
                      )}
                    >
                      <Link href={item.url}>
        ...
        {!isCollapsed ? (
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col flex-1 overflow-hidden">
              <span className="text-sm font-medium leading-none truncate text-foreground">Karan Johar</span>
